...
var conString = 'postgresql://'+process.env.OPENSHIFT_POSTGRESQL_DB_USERNAME+':'+process.env.OPENSHIFT_POSTGRESQL_DB_PASSWORD+'@'+process.env.OPENSHIFT_POSTGRESQL_DB_HOST+':'+process.env.OPENSHIFT_POSTGRESQL_DB_PORT+'/twitter';
...
app.post('/signup', function(req, res, next){
	...
	client.query('insert into login values('+id+','+name+','+password+','+email+','+dob+')', function(err){
